      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 text-center">
          <div className="relative inline-block">
            <div className="w-32 h-32 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full flex items-center justify-center text-4xl font-bold text-white mb-4 mx-auto">
              {editedProfile?.name?.[0] || user?.email?.[0]?.toUpperCase()}
            </div>
          ...
          {isEditing ? (
            <input
              ...
              className="text-3xl font-bold bg-transparent text-white text-center border-b border-purple-500 focus:outline-none focus:border-purple-300"
            />
          ) : (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-purple-500/20 shadow-xl">
                  ...
                  <div className="bg-purple-900/20 p-4 rounded-lg">
                    ...
                    {isEditing ? (
                      <input
                        ...
                        onChange={handleChange}
                        className="w-full bg-transparent text-white border-b border-purple-500 focus:outline-none focus:border-purple-300"
                      />
                    ) : (
                  ...
                  <>
                    ...
                    <div className="bg-purple-900/20 p-4 rounded-lg">
                      ...
                      <input
                        ...
                        value={editedProfile?.yearOfGraduation || ''}
                        onChange={handleChange}
                        className="w-full bg-transparent text-white border-b border-purple-500 focus:outline-none focus:border-purple-300"
                      />
                    </div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-purple-500/20 shadow-xl">
              ...
              {isEditing ? (
                <textarea
                  ...
                  className="w-full h-32 bg-purple-900/20 text-white rounded-lg p-4 border border-purple-500/30 focus:outline-none focus:border-purple-300"
                />
              ) : (
                <div className="flex flex-wrap gap-2">
                  {profile?.skills.map((skill, index) => (
                    <span
                      key={index}
                      className="px-4 py-2 bg-purple-900/40 text-purple-200 rounded-full text-sm border border-purple-500/30"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-purple-500/20 shadow-xl">
              ...
              <div className="space-y-4">
                {isEditing ? (
                  <>
                    <div className="bg-purple-900/20 p-4 rounded-lg">
                      <p className="text-sm text-purple-300 mb-1">LinkedIn URL</p>
                      <input
                        type="url"
                        name="linkedIn"
                    ...
                    <div className="bg-purple-900/20 p-4 rounded-lg">
                      <p className="text-sm text-purple-300 mb-1">GitHub URL</p>
                      <input
                        type="url"
                        name="github"
