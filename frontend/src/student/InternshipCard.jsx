...
const InternshipCard = ({ internship, onTaskToggle }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-900/20 via-black/40 to-indigo-900/20 rounded-lg border border-purple-500/30 hover:border-purple-400 shadow-lg hover:shadow-purple-500/20 transition-all duration-300 transform hover:-translate-y-2 w-full max-w-4xl mx-auto">
  <div className="p-6 backdrop-blur-sm">
    ...
    <div className="mt-4 flex flex-col md:flex-row md:gap-6 gap-4">
      {/* Tasks Section */}
            ...
            {tasks.map((task, index) => (
              <li key={index} className="flex items-center gap-2">
                <input
                  ...
                  className="w-4 h-4 text-purple-600 rounded border-purple-400 focus:ring-purple-500 cursor-pointer bg-purple-900/50"
                />
    ...
    <button
      ...
      className="mt-6 w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-2 rounded-md hover:from-purple-500 hover:to-indigo-500 transition-all duration-300 shadow-lg hover:shadow-purple-500/50"
    >
      Apply Now
    </button>
  </div>
