...
const StudentDashboard = () => {
  ...
  const getFilteredInternships = (internshipList) => {
          ...
          <div className="bg-black/50 p-6 rounded-lg">
            ...
            <div className="mb-8">
              ...
              {internships.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {getFilteredInternships(internships).map((internship) => {
            ...
            <div>
              ...
              {rejectedInternships.length === 0 ? (
                <div className="bg-black/70 p-6 rounded-lg border border-red-500/30 text-center">
                  <p className="text-purple-200">No rejected applications.</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {rejectedInternships.map((internship) => (
                    <div key={internship._id} className="bg-black/80 border border-red-700/60 rounded-lg p-6 text-white">
                      <h3 className="text-lg font-bold text-red-400 mb-2">{internship.title}</h3>
                      <p className="text-sm text-gray-300">{internship.company}</p>
                      <p className="mt-2 text-sm text-red-300 italic">Your application was rejected.</p>
                    </div>
                  ))}
                </div>
              )}
      ...
      case 'your-internships':
        return (
          <div className="space-y-8 px-4 sm:px-6 lg:px-8">
            {/* Shortlisted/Accepted Internships */}
            <div>
              <h2 className="text-2xl font-bold text-purple-200 mb-4 text-center sm:text-left">Shortlisted/Accepted Internships</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {approvedInternships.length === 0 ? (
                  ...
                  approvedInternships.map(internship => (
                    <div 
                      key={internship._id} 
                      className="bg-black/80 rounded-lg border border-green-800/50 hover:border-green-600 shadow-lg hover:shadow-green-900/20 transition-all duration-300 transform hover:-translate-y-1"
                    >
                      <div className="p-6">
                        <div className="mb-4">
                        ...
                        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                          <button className="flex-1 bg-green-900 text-green-100 py-2 rounded-md hover:bg-green-800 transition-colors duration-300 flex items-center justify-center space-x-2">
                          ...
                          {internship.status === "Accepted" && (
                            <button className="flex-1 bg-emerald-900/70 text-emerald-100 py-2 rounded-md hover:bg-emerald-800 transition-colors duration-300 flex items-center justify-center space-x-2">
                              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Ongoing Internship */}
            <div>
              <h2 className="text-2xl font-bold text-purple-200 mb-4 text-center sm:text-left">Ongoing Internship</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-purple-200 mb-4 text-center sm:text-left">Completed Internship</h2>
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gradient-to-br from-purple-950 via-black to-indigo-950">
      {/* Sidebar */}
      <div className="md:w-72 w-full bg-gradient-to-b from-black via-purple-950/50 to-black text-white md:h-full h-auto border-b md:border-b-0 md:border-r border-purple-500/30 shadow-xl z-20 relative backdrop-blur-xl">
        
        {/* Mobile Toggle */}
        <div className="flex md:hidden justify-between items-center p-4 border-b border-purple-500/30 bg-black/40">
        ...
        <div className={`${menuOpen ? "block" : "hidden"} md:block`}>
          ...
          <div className="p-6 border-b border-purple-500/30 bg-black/40">
            <div className="flex items-center space-x-4 mb-4">
              <div className="relative">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-purple-500 to-indigo-500 flex items-center justify-center text-2xl font-bold ring-2 ring-purple-500/30 ring-offset-2 ring-offset-black/50">
                  {user?.name?.[0] || 'S'}
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-purple-300/70 group-hover:text-purple-200/90">{item.desc}</div>
                  </div>
                  {activeTab === item.name && (
          ...
          {/* Logout */}
          <div className="p-4 border-t border-purple-500/30 bg-black/20 backdrop-blur-sm">
            <button
              ...
              className="w-full px-4 py-3 bg-gradient-to-r from-red-900/50 to-purple-900/50 text-white rounded-xl 
                ...
                flex items-center justify-center space-x-2 shadow-lg hover:shadow-purple-500/20 transform hover:-translate-y-0.5"
            >
      ...
      {/* Main Content */}
      <div className="flex-1 overflow-auto p-4 md:p-8 bg-gradient-to-br from-purple-950/90 via-black/95 to-indigo-950/90">
        {loading && (
