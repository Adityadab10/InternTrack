...
const InternshipFilters = ({ filters, setFilters, clearFilters }) => {
  return (
    <div className="bg-gray-900/50 backdrop-blur-sm p-4 rounded-lg border border-purple-500/20 mb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Positions */}
        <div className="space-y-1">
          <label className="text-sm text-purple-300">Minimum Positions</label>
          <input
            type="number"
