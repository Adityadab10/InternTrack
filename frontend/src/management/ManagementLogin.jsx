...
export default function ManagementLogin() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Management login attempt:", formData);
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 to-black p-4">
      <div className="bg-white/10 backdrop-blur-md p-8 rounded-xl shadow-2xl w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Management Login</h1>
          <p className="text-purple-200 text-center mt-2">Institution management dashboard</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="management@institution.edu"
            />
          </div>
